...
_DANGEROUS_PATTERNS = frozenset([
    ...
    "compile(",
    "open(",
    "withopen(",  # Catch 'with open(' after whitespace removal
    "__builtins__",
    "getattr",
    "setattr",
    "delattr",
...
def validate_problem_exists(problem_id: str) -> None:
    ...
    Uses ProblemService to search recursively through problem directories.
    ...
    try:
        # Use ProblemService which searches recursively
        problem_service.get_problem_dir(problem_id)
