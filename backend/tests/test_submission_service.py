...
class TestSubmissionService:
    ...
    def test_get_statistics_with_submissions(self, test_db, sample_submission_data):
        ...
        service.update_job_id(test_db, sub1.id, str(uuid.uuid4()))  # Unique job_id
        ...
        service.update_job_id(test_db, sub2.id, str(uuid.uuid4()))  # Unique job_id
        ...
        service.update_job_id(test_db, sub3.id, str(uuid.uuid4()))  # Unique job_id
    ...
    def test_list_submissions_filter_by_problem(self, test_db, sample_submission_data):
        ...
        sub1 = service.create_submission(db=test_db, problem_id="sumatoria", code="code1")
        service.update_job_id(test_db, sub1.id, str(uuid.uuid4()))  # Unique job_id
        sub2 = service.create_submission(db=test_db, problem_id="sumatoria", code="code2")
        service.update_job_id(test_db, sub2.id, str(uuid.uuid4()))  # Unique job_id
        sub3 = service.create_submission(db=test_db, problem_id="otro", code="code3")
        service.update_job_id(test_db, sub3.id, str(uuid.uuid4()))  # Unique job_id
        test_db.commit()
    ...
    def test_list_submissions_filter_by_student(self, test_db, sample_submission_data):
        ...
        sub1 = service.create_submission(db=test_db, problem_id="sumatoria", code="code1", student_id="alice")
        service.update_job_id(test_db, sub1.id, str(uuid.uuid4()))  # Unique job_id
        sub2 = service.create_submission(db=test_db, problem_id="sumatoria", code="code2", student_id="alice")
        service.update_job_id(test_db, sub2.id, str(uuid.uuid4()))  # Unique job_id
        sub3 = service.create_submission(db=test_db, problem_id="sumatoria", code="code3", student_id="bob")
        service.update_job_id(test_db, sub3.id, str(uuid.uuid4()))  # Unique job_id
        test_db.commit()
